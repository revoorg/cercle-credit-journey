...
export function HotelCard({ hotel }: HotelCardProps) {
  ...
  return (
    <button
      ...
      className="w-[216px] shrink-0 cursor-pointer overflow-hidden rounded-[15px] border border-[#DEE3E6] bg-white text-left transition-shadow hover:shadow-md"
    >
      ...
      <img
        ...
        width={216}
        height={135}
        className="block h-[135px] w-[216px] object-cover"
      />
