...
import { FLASHBACK_BANK_REDIRECT_CE_DATA } from "@/lib/scenario-data";

export function FlashbackBankRedirectCE() {
  ...
  return (
    <div className="flex flex-col px-6 py-6">
      ...
      <h2 className="text-center text-2xl font-semibold leading-[30px] text-[#242A2F]">
        {FLASHBACK_BANK_REDIRECT_CE_DATA.title}
      </h2>
      ...
      <div className="mt-8 flex items-center gap-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-[5px] border border-[#DEE3E6] bg-white overflow-hidden">
          <Image
            src={FLASHBACK_BANK_REDIRECT_CE_DATA.bankLogo}
            alt={FLASHBACK_BANK_REDIRECT_CE_DATA.bankName}
            width={28}
            height={28}
        ...
        <span className="text-lg font-medium leading-[27px] text-[#242A2F]">
          {FLASHBACK_BANK_REDIRECT_CE_DATA.bankName}
        </span>
      </div>
      ...
      <div className="relative mt-8 ml-[18px] pl-[26px]">
        ...
        <div className="relative pb-8">
          ...
          <p className="text-lg font-medium leading-6 text-[#47535C]">
            {FLASHBACK_BANK_REDIRECT_CE_DATA.steps[0].title}
          </p>
          <p className="mt-1 text-base leading-6 text-[#47535C]">
            {FLASHBACK_BANK_REDIRECT_CE_DATA.steps[0].description}
          </p>
        </div>
        ...
        <div className="relative pb-8">
          ...
          <p className="text-lg font-medium leading-6 text-[#47535C]">
            {FLASHBACK_BANK_REDIRECT_CE_DATA.steps[1].title}
          </p>
          <p className="mt-1 text-base leading-6 text-[#47535C]">
            {FLASHBACK_BANK_REDIRECT_CE_DATA.steps[1].description}
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute -left-[29px] top-[3px] h-[5px] w-[5px] rounded-full border border-[#7C8D9A] bg-[#7C8D9A]" />
          <p className="text-lg font-medium leading-6 text-[#47535C]">
            {FLASHBACK_BANK_REDIRECT_CE_DATA.steps[2].title}
          </p>
          <p className="mt-1 text-base leading-6 text-[#47535C]">
            {FLASHBACK_BANK_REDIRECT_CE_DATA.steps[2].description}
          </p>
        </div>
      </div>
      ...
      <p className="mt-auto pt-10 text-center text-[15px] italic leading-[21px] text-[#47535C]">
        {FLASHBACK_BANK_REDIRECT_CE_DATA.disclaimer}
      </p>
      ...
      >
        {FLASHBACK_BANK_REDIRECT_CE_DATA.buttonText}
      </button>
    </div>
  );
}
