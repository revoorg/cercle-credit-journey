...
import { FLASHBACK_CE_PROGRESS_DATA } from "@/lib/scenario-data";

export function FlashbackCEProgress() {
  return (
    <div className="flex flex-col items-center px-6">
      {/* Title */}
      <h2 className="mt-6 text-center text-2xl font-semibold leading-[30px] text-[#242A2F]">
        {FLASHBACK_CE_PROGRESS_DATA.title}
      </h2>

      {/* CE icon with green lock */}
      <div className="relative mt-16">
        <div className="flex h-14 w-14 items-center justify-center overflow-hidden rounded-[5px] border border-[#DEE3E6] bg-white">
          <Image
            src={FLASHBACK_CE_PROGRESS_DATA.bankLogo}
